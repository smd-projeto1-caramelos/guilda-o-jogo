...
function CampoOrquideas({ result, setResult}: any) {
  ...
  return(
    <>
      <Image url="./img/progressao-6.png" className="background-image background-image-progressao" />
      <Image url="./img/campo-orquideas.png" className="background-image background-image-cenario" />
