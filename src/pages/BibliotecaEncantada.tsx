...
function BibliotecaEncantada({ result, setResult}: any) {
  ...
  return(
    <>
      <Image url="./assets/progressao-3.png" className="background-image background-image-progressao" />
      <Image url="./assets/biblioteca-encantada.png" className="background-image background-image-cenario" />
