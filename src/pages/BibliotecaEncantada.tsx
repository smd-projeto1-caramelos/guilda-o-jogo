...
function BibliotecaEncantada({ result, setResult}: any) {
  ...
  return(
    <>
      <Image url="src/assets/progressao-3.png" className="background-image background-image-progressao" />
      <Image url="src/assets/biblioteca-encantada.png" className="background-image background-image-cenario" />
